import { ApolloClient, OperationVariables, MutationOptions, ApolloError, NetworkStatus } from "@apollo/client/core";

import { FetchResult, DocumentNode } from "@apollo/client/link/core";
